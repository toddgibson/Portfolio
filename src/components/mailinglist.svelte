<div class="text-center">
    ...
    <img src="/images/toddmakesgames-header.png" alt="Todd Gibson" class="img-fluid" style="max-width: 580px; border-radius: 7px;" />
</div>

<div class="text-center" style="margin-top: 20px;">
    I will keep you up to date on my upcoming titles, including my new action roguelite!
</div>

<div class="text-center" style="margin-top: 20px;">
    <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSeqJra9XWMC-HFeYzzqd6pdXc2C3cbRJmREoHtv95YQ3XGjxw/viewform?embedded=true" width="640" height="1008" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
</div>
